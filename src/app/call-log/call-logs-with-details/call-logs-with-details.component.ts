...
@Component({
  selector: 'app-call-logs-with-details',
  templateUrl: './call-logs-with-details.component.html',
  styleUrls: ['./call-logs-with-details.component.css']
})
export class CallLogsWithDetailsComponent implements OnInit {
